...
obj <- .CreateSeuratObj("Data/GF_Citro.txt", Pname = "GF_Citro", minCells = 5, minGenes = 200, matrix = F, sep = "\t")
...
#plot it
plot(dend, type = "rectangle", ylab = "Height", edgePar = list(col = 2:3, lwd = 2:1), leaflab = "none", main = "GF_Citro Consensus Tree")
...
obj <- JackStraw(object = obj, num.replicate = 100, display.progress = TRUE,  num.cores = 6)
...
#obj <- RunTSNE(object = obj, dims.use = 1:5, do.fast = TRUE)
#TSNEPlot(obj, main = "Nippo Tsne Plot")
...
# Run significant clustering on the significant PCs
```{r}
result <- .run_dip(50, data_pca, varGenes = varGenes, pcs = T)
```
