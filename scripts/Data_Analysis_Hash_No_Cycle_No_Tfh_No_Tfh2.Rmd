---
title: "Data Analysis Hash noCycle noMyeloid noTfh noTh2"
...
obj <- .CreateSeuratObj("Data/Hash_noCycle_noMyeloid_noTfh_noTh2.txt", Pname = "Hash_noCycle_noMyeloid_noTfh_noTh2", minCells = 5, minGenes = 200, matrix = F, sep = "\t")
...
```{r}
pdf("Results/Hash_noCycle_noMyeloid_noTfh_noTh2_plots.pdf")
...
hist(varGenes_dist, main = paste("Hash No Tfh No Th2 density plot on all variable genes. \nDip Test p-value =", round(varGenes_dip, 4)), xlab = "Distance", probability = T, col = "lightblue")
...
# Save the plots
```{r}
pdf("Hash_noCycle_noMyeloid_noTfh_noTh2.pdf")

plot(result$plot, use_labs = F) + ggtitle("Significance clustering on top 350 variable genes")
plot(dend, type = "rectangle", ylab = "Height", edgePar = list(col = 2:3, lwd = 2:1),main = "Consensus Tree, p = 0027",  leaflab = "none")
...
write.csv(all_labels, file = "Hash_noCycle_noMyeloid_noTfh_noTh2_clustering_labels.csv")
```
...
hist(fit$lambda, main = paste("Hash No Tfh No Th2 density plot on Principal Curves. \nDip Test p-value =", round(fit_dip, 4)), xlab = "Distance", probability = T, col = "lightblue")
...
pdf("Hash_noCycle_noMyeloid_noTfh_noTh2_All_Density_Z_Score_plots.pdf")
for(i in seq_vals){
  #first run PCA
...
hist(pca_dist, breaks = 300,  main = paste("Hash No CC No Tfh No Th2 density plot on significant PCs on \n", i, "variable genes", "\nDip Test p-value =", round(pca_dip,4)), xlab = "Distance", probability = T, col = "lightblue")
lines(density(pca_dist), col="red", lwd=2)
...
```{r}
dip_list <- NULL
seq_vals <- seq(50,600, by = 50)
pdf("Results/Hash_noCycle_noMyeloid_noTfh_noTh2_Density_hyperplane_plots.pdf")
for(i in seq_vals){
