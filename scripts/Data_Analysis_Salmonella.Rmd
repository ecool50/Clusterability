---
title: "Data Analysis Salmonella"
...
obj <- .CreateSeuratObj("Data/Salmonella.txt", Pname = "Sal", minCells = 5, minGenes = 200, matrix = F, sep = "\t")
...
#plot it
plot(dend, type = "rectangle", ylab = "Height", edgePar = list(col = 2:3, lwd = 2:1), leaflab = "none", main = "Salmonella Consensus Tree")
...
```{r}
pdf("Results/Salmonella_Density_Plots.pdf")
...
hist(varGenes_dist, main = paste("Salmonella density plot on all variable genes. Dip Test p-value =", round(varGenes_dip, 4)), xlab = "Distance", probability = T, col = "lightblue")
...
hist(pca_dist, main = paste("Salmonella density plot on significant PCs. Dip Test p-value =", round(pca_dip,4)), xlab = "Distance", probability = T, col = "lightblue")
...
hist(pc_1, main = paste("Salmonella density plot on the first PC. Dip Test p-value =", round(pc_1_dip,4)), xlab = "Distance", probability = T, col = "lightblue")
...
hist(dist_full, main = "Salmonella Density Plot", xlab = "Distance", probability = T, col = "red")
...
hist(pc_1, main = "Salmonella Density Plot of the first PC", xlab = "Value", probability = T, col = "red")
